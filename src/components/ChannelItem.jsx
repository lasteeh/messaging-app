...
const ChannelItem = (props) => {
  return (
    <div
      ...
      className="channel-item flex flex-row justify-start items-stretch w-[100%] max-w-[280px] p-1  rounded-2xl hover:scale-105  transition ease-in-out cursor-pointer shadow-md"
