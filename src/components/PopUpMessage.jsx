...
const PopUpMessage = () => {
  ...
  return (
    <div className="fixed top-[3rem] left-[50%] translate-x-[-50%] isolate z-[200] max-h-[190px] overflow-hidden">
      <div className=" w-[fit-content]  bg-red-900 px-[1.25rem] py-[0.5rem] pr-[0.9rem] rounded-[5px] shadow-md text-white flex flex-row gap-[1rem] items-center justify-center my-[1rem]">
