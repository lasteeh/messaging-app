...
import { faHashtag, faComments, faPoo, faEllipsis } from '@fortawesome/free-solid-svg-icons';
...
export default function ChatHeader(props) {
    ...
    <div className="chat-box-header flex flex-row items-center p-2.5 justify-start w-[100%] min-h-[80px] gap-[5px] isolate z-[6]">
        ...
        <FontAwesomeIcon
            ...
            icon={
            props.chatheader === undefined ||
            props.chatheader === `Welcome, User ${props.username}!`
                ? faPoo
                : props.chatheader !== undefined &&
